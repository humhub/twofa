...
return [
    ...
    'Enabled methods' => '',
    'Install an application that implements a time-based one-time password (TOTP) algorithm, such as <a{docLinkAttrs}>Google Authenticator</a>, and use it to scan the QR code shown below.' => '',
